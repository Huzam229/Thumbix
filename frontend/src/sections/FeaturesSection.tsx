  ...
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          AI Thumbnail Generator helps you create eye-catching video thumbnails
          in seconds, turning your ideas into high-converting visuals.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              Boost Your View with AI-optmized designs.{" "}
            </h3>
            <p className="text-slate-300 mt-2">
              Stop guessing what works. Our AI crafts thumbnails designed to
              maximize clicks and engagement.
            </p>
            <Link to="/generate"
